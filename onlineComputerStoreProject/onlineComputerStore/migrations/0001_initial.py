# Generated by Django 2.2.5 on 2021-05-02 08:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_name', models.CharField(blank=True, default=None, max_length=20, null=True)),
                ('gpu_name', models.CharField(blank=True, default=None, max_length=20, null=True)),
                ('memory_name', models.CharField(blank=True, default=None, max_length=20, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('num_cuda_cores', models.IntegerField(blank=True, default=0, null=True)),
                ('core_clock', models.FloatField(blank=True, default=0.0, null=True)),
            ],
            bases=('onlineComputerStore.item',),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('order_number', models.UUIDField(default=uuid.UUID('3a09fad9-ab21-11eb-874b-207918e81943'), editable=False)),
